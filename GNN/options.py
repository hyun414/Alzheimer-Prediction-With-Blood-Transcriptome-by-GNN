...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=32, help='Number of batches to train/test for. Default: 64')
    ...
    parser.add_argument('--label_dim', type=int, default=2, help='size of output, grad task: label_dim=2, surv task: label_dim=1')
    parser.add_argument('--input_dim', type=int, default=1, help="input_size for omic vector")
    parser.add_argument('--lin_input_dim', type=int, default=958, help="the feature extracted by GAT layers")
    ...
    parser.add_argument('--omic_dim', type=int, default=10, help="dimension of the linear layer")
    ...
    parser.add_argument('--adj_thresh', default=0.05, type=float, help='Threshold convert the similarity matrix to adjacency matrix')
